                ...
                >
                  <div className="space-y-2.5">
                    ...
                    <div className="space-y-1.5 text-xs text-slate-600 dark:text-slate-400">
                      ...
                      {v.catatan && (
                        <p className="text-[11px] text-slate-500 italic bg-slate-50 dark:bg-slate-800/60 p-2 rounded-lg border border-slate-100 dark:border-slate-800">
                          "{v.catatan}"
                        </p>
                      )}
                    </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4">
          <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl p-6 space-y-4">
            ...
            <form onSubmit={handleSubmitVendor} className="space-y-4 text-xs">
              ...
              <div>
                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                  Catatan Khusus (Syarat Pembayaran / Tempo)
                </label>
                <input
                  type="text"
                  placeholder="Contoh: Tempo 14 hari, diskon 5% untuk pembelian min 5 roll"
